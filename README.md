...
Members post work as portfolio pieces, process notes, experiments, reels, music, writing, visuals, talks, or project case studies. Work should help others understand taste, craft, availability, and fit.

### 4. Find Opportunity

Members browse jobs, gigs, collaborations, events, and open calls. Posters can review interested creatives through profiles and relevant work instead of only resumes.
...
Profiles should answer: Who is this person? What do they make? What are they looking for? How can I work with them?

Expected profile features:

- Name, bio, location, role, creative disciplines, and availability
- Social links and external portfolio links
- Work cards for images, text, video, audio, links, and mixed-media case studies
- Searchable profile content and work metadata
- Signals for current interests, open questions, or collaboration needs

### Work Sharing

Work sharing is the community's credibility layer. It should feel more like a living portfolio than a generic feed.

Expected work features:

- Public or community-only work posts
- Multi-block work cards with text, image, link, audio, and video support
- Tags for discipline, medium, tools, industry, and collaboration context
- Ability to attach work to job interest, event applications, and profile highlights
...
- Job, gig, freelance, full-time, part-time, contract, open-call, and collaboration listings
- Search and filters by discipline, location, remote status, and experience level
- Interest flows that let creatives attach a note and relevant work
- Poster tools to review interested members and close listings
...
- Public events that help grow the top of funnel
- Member-only events that reward account creation
- Paid insider events that justify membership
- Event pages with speaker/artist profiles, schedule, livestream or replay embeds, chat/discussion links, and follow-up resources
- Support for online, physical, and hybrid gatherings
...
- Discussion spaces around disciplines, cities, events, projects, and opportunities
- Private responses or lightweight messaging
...
- Closed interviews and conversations
- Private workshops, critique sessions, and office hours
- Early access or discounted tickets
- Replays and archives
- Insider-only discussion spaces
- Direct introductions or curated opportunity drops

## Initial Feature Map

| Area | Free Public | Free Account | Paid Insider |
| --- | --- | --- | --- |
