...
export const CAMPAIGN_QUOTES: Record<CampaignImageKey, CampaignQuote> = {
  ...
  church: { said: "Joshua's on my worship team Sundays. Now he plays bars and festivals too.", who: "Pastor Dan" },
  busker: { said: "Church is where I started playing. It's not where I stop.", who: "Joshua, musician" },
