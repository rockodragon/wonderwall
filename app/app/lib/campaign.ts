...
export const CAMPAIGN_QUOTES: Record<CampaignImageKey, CampaignQuote> = {
  shua: { said: "I stopped taking the third job.", who: "musician" },
  june: { said: "I write on purpose now, not on leftovers.", who: "writer" },
  ade: { said: "I took the class I had been putting off for two years.", who: "ceramicist" },
  marta: { said: "I was already teaching for free on Thursdays.", who: "woodworker" },
  gallery: { said: "The cohort paid for itself, then it paid me.", who: "photography host" },
  band: { said: "Fifty dollars a month. She finished the record.", who: "patron" },
  viewing: { said: "I knew the person before the work existed.", who: "patron" },
  church: { said: "He's on my worship team Sundays. Now he plays bars and festivals too.", who: "worship leader" },
  busker: { said: "Church is where I started playing. It's not where I stop.", who: "musician" },
  dee: { said: "$250 bought a month of film. It turned into a whole show.", who: "donor" },
  cafe: { said: "I can see which creative my money reached.", who: "donor" },
  night: { said: "The room is full on a Tuesday now.", who: "cafe owner" },
  opening: { said: "We gave them the back room. They gave us a reason to open early.", who: "gallery owner" },
  pair: { said: "I had bought art before. This was the first time I knew the person.", who: "patron" },
};
