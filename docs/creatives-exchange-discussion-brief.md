...
| A patron backs a creative, project, or fellowship | **90% the work · 10% platform.** On the part of a single gift above $1,000, the platform takes 5% |
| A class fee | **90% the host · 10% platform** |
| A patron pays a creative directly (we made the connection) | **100% the creative** — we record it and take nothing |
| Giving through the community's own giving page | **100% the community** — this money never passes through us (spelled out below) |

**On project money, we mostly facilitate at this stage.** A paid project or a fellowship can be arranged straight between the patron and the creative: they agree, the patron pays them directly, and we record it. We take nothing on money we don't move. The 10% applies when money moves through our checkout — dues, class fees, backings paid on the platform. Over time more of it can move through us; for now, making the connection is the job.
...
The money words are the same everywhere: **Seat, Patron, Project, Fellowship.** A seat is a paid membership in a community. These words show up on receipts, so they never change. The gathering word defaults to **Class**; a community can use its own — Workshop, Circle, Cohort.
...
3. Honesty about what we'd replace versus complement. Tell us what already works — your giving platform, mailing list, curriculum — and we plug into it instead of rebuilding it.
