# Partner landscape — creatives.exchange
...
## 1 · Who to approach, in order

**Local network — already in motion. Close these before opening new fronts.**
...
**National org conversations — prospective host communities.**

| Rank | Org | Why now | First ask | Person |
|---|---|---|---|---|
| 1 | **Inkwell** (formerly Ekstasis, Christianity Today) | "Inkwell Local" is already a network of recurring in-person creative gatherings — Tables with no software. CT is mid-way through a $32M campaign whose next-gen pillar funds Inkwell: budget and will are pointed at this exact space right now. 13k+ newsletter subs ⚠. | Pilot: run 2–3 Inkwell Local cities on the platform (RSVP, portfolios, gatherings). | Conor Sweetman, founding editor / CT Director of Innovation. |
| 2 | **Art House** (Nashville / Dallas / St. Paul) | Strongest structural twin found: capped 15-person monthly "Awaken Creativity Groups" plus larger "Art House Exchange" gatherings — Dallas alone ran 120+ events for 2,500+ attendees in 2025 on Squarespace + Eventbrite. Multi-city with no membership software. | One city as a host community; Dallas is the most active. | Nathan & Cassie Tasker (Nashville); Dallas director TBD. |
| 3 | **The Rabbit Room** (Nashville) | The marquee brand: 32k+ Substack, $25/mo membership, Hutchmoot (400+), press, North Wind Manor. But FY2024 shows a ~$498K deficit on $2.04M revenue, and their community runs on Substack + Shopify + Universe with no forum of their own. The pitch is consolidation and cost relief, not another expense. | Start small: Rabbit Room Poetry (7k subs in 18 months) as a community, or co-promotion at Hutchmoot (Oct 7–10, Franklin). | Dave Bruno, Executive Director. |
| 4 | **Makers & Mystics / The Breath & the Clay** (Stephen Roach, Winston-Salem) | Cleanest swap-in: 444 paying Patreon members, a Mighty Networks subscription they already pay for, and a monthly first-Friday online gathering — our exact feature set, rented from three vendors. | Replace Patreon + Mighty Networks; conference (Mar 20–22) as the moment. | Stephen Roach. |
| 5 | **Anselm Society** (Brian Brown, Colorado Springs) + **Square Halo** (Ned Bustard, Lancaster) | Small, high-touch, identity-protective — approach as hub nodes, not tenants. Anselm's guild is application-gated and currently closed; Square Halo runs its own paid "Neighborhood" community. Both are warm-intro routers to everyone else. | Advisory + intros first; tenancy later if they raise it. | Brown; Bustard. |
...
- **Practicing the Way** — study, don't pitch. Free formation content + small-group infrastructure reached 56,472 groups in 147 countries on $5.3M/yr. The free-tier logic and their RightNow Media distribution deal are templates.

**Handle with care: Relevant Magazine.** Claimed 5M/month reach in the right demographic, but the founder's 2019 departure over staff allegations of toxic leadership (Washington Post, MinistryWatch) ended with his return six months later, and the concerns coverage never closed. For-profit, personality-run. If ever: media partnership only, later, and not first.
...
- **The launch event is Nov 6** — 125–150 patrons and leaders, Del Mar/Encinitas, mixer format that recreates the product in person (rotating tables, join-a-table on the spot). Every partner conversation above should end with a Nov 6 invitation.
- **The Grove's board is asking our question in their own words** ("how might the Grove serve other arts ministries"). That conversation is warm now, not after launch.
- **Ryan's film series is the recruitment engine.** Cinematic 2-minute testimonials, ~2 months to deliver, first subject candidates: Maxine's creative process, an AP fellowship story. The same format later tells every migration story.
- **Curation is the differentiator the group already believes in.** Quality bar ("a certain quality... flag-planting"), provisioned communities, no open marketplace.
- **Platform-level identity stays broad; community-level identity stays convictional.** "We can't be pounding the table that we're Christians" at the front door, while AP remains explicitly Christ-and-craft inside. This matches how we've split platform vs community language everywhere else.
- **Offers widen beyond money**: donated space, "Third Thursdays" back rooms, gear leasing, studio rentals — "the currency of the arts isn't always in money." Also the asks lane: artists in genuine material need.
- **Open question to answer before pitching orgs: "who owns the work?"** Ryan raised creator IP/revenue share directly. We need the one-paragraph answer in writing.

---

## 4 · The platform landscape (verified Aug 2026)

| Platform | Creator/host pays | Take on money | Members get | Cross-community? |
|---|---|---|---|---|
| Skool | $9/mo +10% txn, or $99/mo +2.9% | 10% or 2.9% | feed, courses, calendar, leaderboards | Yes — Discovery, 170k+ communities ⚠ |
| Substack | $0 | 10% + Stripe ~3% | newsletter, Notes, Chat, live video | Yes — recommendations network |
| Patreon | $0 | 10% (new creators) + processing | tiers, posts; Niches/Clips since Aug 2026 | Barely — closed loop until last week's patch |
| Mighty Networks | $79–179/mo | 1–2% + Stripe | branded single community, native apps | No |
| Circle | $89–199/mo + add-ons | 1–2% + Stripe | all-in-one creator back office | No |
| Ghost | $29/mo | 0% + Stripe | publishing only | No |
| Discord | $0 | 10% on native memberships | real-time chat/voice | Rudimentary |
| **creatives.exchange** | **$0** | **10% of money in motion** | portfolio, projects, funding, tables w/ video, events | **Yes — one membership, curated set** |

Worth repeating in the room:
...
## 5 · Ecosystem notes not covered above

- **Rabbit Room detail:** ED Dave Bruno (since 2023); membership $25+/mo or $300/yr; 20th anniversary in 2026; MinistryWatch transparency grade D — a diligence flag for us, and a reason budget relief may resonate.
- **Inkwell detail:** Ekstasis founded 2016 by Conor Sweetman, folded into CT and renamed Inkwell in 2025; self-reported 880k Substack reads, 1,000+ live-event attendees ⚠. Two other "Inkwells" exist (a small NC critique group at $12.99/mo; a BJU student magazine) — don't confuse them in outreach.
- **Anselm:** $12/mo membership, $100/mo patron tier; community lives in a Facebook group; guild capped, closed to applicants, Colorado Springs in-person required.
- **Square Halo:** publisher + foundation + gallery + "The Neighborhood" paid community (three tiers, pricing undisclosed); 7th conference Mar 6–7, Lancaster.
- **Christos Collective (Denver):** application-gated national collective on Slack + Zoom; publishes annual reports; high-commitment culture may resist portability.
- **CITA (theatre):** site is a "coming soon" placeholder — likely dormant; low priority.

---

## 6 · Named creator targets

**Tier 1 — gather creatives around craft and already run paid gatherings:**

| Who | What | Size | Why they'd move |
|---|---|---|---|
| Jonathan Rogers — The Habit | writing membership $19.95/mo | ~7.7k ⚠ | Already runs Substack + own site + Zoom office hours + forums + 24-writer cohorts + retreats. We replace four tools. Warm path via Rabbit Room podcast network. |
| Laura Wifler | poetry/essays, paid tier | 17k+ | Risen Motherhood wound down 2025; she is rebuilding her platform right now. Timing is the pitch. |
| Nicole Roccas | writing cohorts | low thousands ⚠ | Runs live Thursday cohorts on top of Substack today. |
| Hilary White — Sacred Images Project | sacred visual art | thousands ⚠ | Already sells a $125/yr "Patron" tier; authenticity-versus-AI is her theme. |
| Karen Swallow Prior — The Priory | read-along series | 14k+ | Her multi-month read-togethers are cohorts begging for real tooling. |

**Fragmentation signals (running two platforms at once — the pain is visible):** Tsh Oxenreider (41k free Substack + separate Patreon), Sarah Clarkson (free Substack + paid Patreon "Vicarage Library").

**Reach and network nodes:** Paul Kingsnorth (~76–85k ⚠, cultural not craft), Micah Mattix/Prufrock (20k, poetry curation — marketing ally), Haley Stewart (10k, Word on Fire), Jessica Hooten Wilson (4.7k), Malcolm Guite (tiny Substack but ~100k YouTube and ties across Rabbit Room/Inkwell circles — approach for blessing and intros).
...
1. **Lead with "keep your Substack."** Free posts remain their reach engine; community, gatherings, and money move here. David's AP plan is the demo.
2. **Offer concierge migration.** Below 100k subs, nobody offers help. We do it for them — content export, list import, redirects.
3. **Paid supporters move via Stripe.** Same Stripe account = subscriber Stripe IDs carry over (Ghost's migrator proves the pattern). We're Stripe-native. Note: subscriptions left running on Substack keep paying Substack ⚠ — conversion, not abandonment.
4. **Handle their old post URLs** (Substack's /p/ paths need redirects) so they lose no links.
5. **Decide whether to offer a first-year courtesy** — e.g., waive our 10% on migrated recurring support for 6–12 months. No platform publicly offers a switching incentive; it's ours to own if we want it.
6. **Tell each migration as a film.** Ryan's testimonial format is the case-study machine.

---

## 8 · Next 60–90 days (to Nov 6)

1. Close the Grove as host community #3; set Temple in motion as #4.
2. Answer "who owns the work?" in one written paragraph before any org pitch.
3. Greenlight Ryan's pilot film (AP fellowship story) — needed by launch.
4. Email Belmont's Creative Arts Collective; introduce the platform as shared infrastructure for their grantees.
5. Open the Inkwell conversation with Conor Sweetman — the pilot ask is small (2–3 Inkwell Local cities).
6. Route intros through Bustard/Brown/Guite circles rather than cold; Hutchmoot is Oct 7–10 if we want to be in the room.
7. Start one Tier-1 creator conversation (Rogers first) to prove the migration playbook.
8. Invite every warm contact to Nov 6.
