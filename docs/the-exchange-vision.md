...
flowchart TB
    ...
    classDef space fill:#E8F5E9,stroke:#43A047,color:#000
    classDef inside fill:#FFF8E1,stroke:#FBC02D,color:#000
    classDef cross fill:#E1F5FE,stroke:#0288D1,color:#000

    EXC[🌐 The Garden — multi-tenant platform<br/>shared identity · discovery · showcase]:::platform

    EXC --> SPACES[🏛️ Spaces<br/>org-operated communities]:::space
    EXC --> THEMES[🏷️ Cross-Space Themes<br/>#photography · #worship · #ministry<br/>discovery without tenancy]:::cross
    EXC --> SHOWCASE[🌟 Cross-Space Showcase<br/>platform-wide stories]:::cross

    SPACES --> AP[🏛️ AP — Abiding Practice]:::space
    SPACES --> TAS[🏛️ TAS — Table Art Society]:::space
    SPACES --> FUT[🏛️ Future aligned Spaces<br/>church planter networks ·<br/>regional arts councils ·<br/>denomination creative networks]:::space

    AP --> INSIDE[Inside each Space:<br/>👥 People · 🪑 Tables · 📋 Projects<br/>📜 Fellowships · 📅 Events<br/>🧭 Pathfinding · 📖 Stories]:::inside
    TAS -.same building blocks.-> INSIDE
    FUT -.same building blocks.-> INSIDE

    INSIDE -.tagged with.-> THEMES
    INSIDE -.stories feed.-> SHOWCASE
```
...
flowchart TB
    ...
    classDef community fill:#FFF8E1,stroke:#FBC02D,color:#000
    classDef operator fill:#E8F5E9,stroke:#43A047,color:#000
    classDef sponsor fill:#FFF3E0,stroke:#FB8C00,color:#000
    classDef outcome fill:#FCE4EC,stroke:#D81B60,color:#000

    A[🎨 Creative proposes project<br/>scope · intent · ask]:::creative
    A --> POSTED[📋 Posted to Space + tagged with Themes]
    POSTED --> S{Funding path?}

    S -->|Grant Pool<br/>Space-funded| GP[Community signals support<br/>then operator + jury discerns<br/>weighing signal + fit + craft]:::community
    S -->|Sponsor-Posted<br/>Sponsor-funded| SP[Creatives apply<br/>community engages<br/>sponsor has primary say<br/>operator advises]:::sponsor
    S -->|Micro-grant<br/>Patron-direct| MP[Patrons browse and pledge<br/>visibility drives discovery<br/>funded when target met]:::sponsor

    GP --> FUND[💰 Funded — kick off]:::outcome
    SP --> FUND
    MP --> FUND

    FUND --> STORY[📖 Public story page<br/>credits patron + Space]:::outcome
    STORY --> LOOP[🌟 Story feeds showcase<br/>draws next patrons + creatives]
```
...
flowchart TB
    ...
    PATRON[💖 Patron seeks<br/>ongoing relationship]:::sponsor
    PATRON --> FELL{Curated or Direct?}

    FELL -->|Curated| FC[Operator surfaces creative<br/>matches with patron<br/>both commit to stipend]:::operator
    FELL -->|Direct| FD[Patron finds creative<br/>initiates ongoing support<br/>creative accepts]:::sponsor

    FC --> FUND[💰 Fellowship live]:::outcome
    FD --> FUND

    FUND --> STORY[📖 Public Fellowship story page<br/>credits patron + Space]:::outcome
```
...
> **Date and venue decided (2026-08-31): Friday, November 6, 2026 at Lightchurch in Encinitas.** Event title (decided 2026-08-31): **"The Creative Economy We All Need."** The evening is about the funding engine — the platform, the fund, the community — not a performance showcase. (Supersedes the earlier October target and the La Paloma / North Coast Calvary venue scoping below-referenced elsewhere in this doc.)
...
```mermaid
pie title Year 1 Foundation revenue mix (~$42k total)
    "Founding Patron partnership" : 15000
    "Setup investments" : 12000
    "Showcase + event sponsors" : 8000
    "10% of flow (net)" : 6500
```
